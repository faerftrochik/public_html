...
$stormea_theme_divider_style = array(
...
$stormea_title                         = __( 'From Ideas to Life—With a Squeeze!', 'stormea' );
$stormea_subtitle                      = __( 'Bringing your imaginative ideas to life with boundless imagination and innovative thinking is a remarkable journey that thrives on the synergy of innovation.','stormea' );
$stormea_theme_action_button           = __( 'Button 1', 'stormea' );
$stormea_theme_action_button_secondary = __( 'Button 2', 'stormea' );

$defaults = array(
	'default_icon'                      => $stormea_theme_svg_icons['fort-awesome'],
	'icons'                             => $stormea_theme_svg_icons,
	'divider_style'                     => $stormea_theme_divider_style,
	'gradients'                         => $stormea_gradients,

	'assets_js_key'                     => 'kubioFrontendData',

	'edit_this_text_in_customizer'      => $stormea_title,
	'lorem_ipsum'                       => $stormea_subtitle,
	...
	'front-header'                      => array(
		...
		'buttons'      => array(
			...
			'value' => array(
				array(
					'label'       => sprintf( $stormea_theme_action_button, 1 ),
					'url'         => '#',
					'button_type' => '0',
					'index'       => 0,
				),
				array(
					'label'       => sprintf( $stormea_theme_action_button_secondary, 1 ),
					'url'         => '#',
					'button_type' => '1',
					'index'       => 1,
				),
		...
		'subtitle'     => array(
			'show'  => true,
			'value'      => $stormea_subtitle,
			'localProps' => array(
				'content' => $stormea_subtitle
			),
			'style' => array(
				'descendants' => array(
					'text' => array(
						...
						'background' => array(
							...
							'overlay'   =>
								array(
									...
									'gradient'         => $stormea_gradients['night_fade'],
		...
		'social_icons' => array(
			...
			'localProps' => array(
				'iconList' => array(
					array(
						'icon'       => $stormea_theme_svg_icons['facebook-square-full'],
						'link_value' => '#',
						'index'      => 0,
					),
					array(
						'icon'       => $stormea_theme_svg_icons['twitter-x'],
						'link_value' => '#',
						'index'      => 1,
					),
					array(
						'icon'       => $stormea_theme_svg_icons['youtube'],
						'link_value' => '#',
						'index'      => 2,
					),
					array(
						'icon'       => $stormea_theme_svg_icons['vimeo'],
						'link_value' => '#',
						'index'      => 3,
					),
				),
		...
		'icon_list'    => array(
			...
			'localProps' => array(
				'iconList' => array(
					array(
						'icon'       => $stormea_theme_svg_icons['map-marker'],
						'text'       => '123, Main Street, City, Country',
						'link_value' => 'https://maps.google.com/',
						'index'      => 0,
					),
					array(
						'icon'       => $stormea_theme_svg_icons['phone'],
						'text'       => '+1 234 567 890',
						'link_value' => 'tel:+1 234 567 890',
						'index'      => 0,
					),
					array(
						'icon'       => $stormea_theme_svg_icons['envelope'],
	...
	'header'                            => array(
		...
		'social_icons' => array(
			...
			'localProps' => array(
				'icons' => array(
					...
					array(
						'icon'       => $stormea_theme_svg_icons['whatsapp-square'],
						'link_value' => '#',
						'index'      => 1,
					),
					array(
		...
		'icon_list'    => array(
			...
			'localProps' => array(
				'iconList' => array(
					array(
						'icon'       => $stormea_theme_svg_icons['map-pin'],
						'text'       => '1557 Frosty Lane, Binghamton, NY',
						'link_value' => '#',
						'index'      => 0,
					),
					array(
						'icon'       => $stormea_theme_svg_icons['phone-square'],
	...
	'front_page_designs'                => array(
		array(
			'name'    => __( 'Modern', 'stormea' ),
			'index'   => 1,
			'preview' => 'front-page-1.jpg',
		),

		array(
			'name'    => __( 'Fullscreen', 'stormea' ),
			'index'   => 2,
			'preview' => 'front-page-2.jpg',
		),

		array(
			'name'    => __( 'Classic', 'stormea' ),
			'index'   => 3,
